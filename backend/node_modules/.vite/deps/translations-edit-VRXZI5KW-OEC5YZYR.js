...
} from "./chunk-DCD5HFWX.js";
import "./chunk-EGRHWZRV.js";
import {
  KeyboundForm
} from "./chunk-DP54EP6X.js";
import "./chunk-RZOOGYFK.js";
import {
  RouteFocusModal,
  useRouteModal
} from "./chunk-IN3QVUOA.js";
import "./chunk-OIVT6BFX.js";
import "./chunk-O6KMSJEJ.js";
import {
  t
...
// node_modules/@medusajs/dashboard/dist/translations-edit-VRXZI5KW.mjs
...
var TranslationsEditForm = ({
  ...
  const [dynamicColumnWidth, setDynamicColumnWidth] = (0, import_react.useState)(400);
  ...
  const [selectedLocale, setSelectedLocale] = (0, import_react.useState)(
    ((_a = availableLocales[0]) == null ? void 0 : _a.locale_code) ?? ""
  );
  const [showUnsavedPrompt, setShowUnsavedPrompt] = (0, import_react.useState)(false);
  const [pendingLocale, setPendingLocale] = (0, import_react.useState)(null);
  const [isSwitchingLocale, setIsSwitchingLocale] = (0, import_react.useState)(false);
  ...
  const knownEntityIdsRef = (0, import_react.useRef)(
    new Set(references.map((r) => r.id))
  );
  const latestPropsRef = (0, import_react.useRef)({ translations, references });
  (0, import_react.useEffect)(() => {
  ...
  const totalRowCount = (0, import_react.useMemo)(
    () => referenceCount * (translatableFields.length + 1),
    [referenceCount, translatableFields]
  );
  const selectedLocaleDisplay = (0, import_react.useMemo)(
    () => {
      var _a2;
  ...
  const saveCurrentLocale = (0, import_react.useCallback)(async () => {
    const currentValues = form.getValues();
  ...
  const switchToLocale = (0, import_react.useCallback)(
    async (newLocale) => {
  ...
  const handleLocaleChange = (0, import_react.useCallback)(
    (newLocale) => {
  ...
  const handleSaveAndSwitch = (0, import_react.useCallback)(async () => {
  ...
  const handleCancelSwitch = (0, import_react.useCallback)(() => {
    setShowUnsavedPrompt(false);
    setPendingLocale(null);
  }, []);
...
var TranslationsEdit = () => {
  ...
  const {
    ...
    reference,
    (translatable_fields == null ? void 0 : translatable_fields[reference]) ?? [],
    referenceIdParam,
    {
...
//# sourceMappingURL=translations-edit-VRXZI5KW-OEC5YZYR.js.map
