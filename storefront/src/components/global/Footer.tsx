            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
                    <div className="space-y-6">
                        <h2 className="font-black text-2xl tracking-tighter">TGE STORE</h2>
                        <p className="text-zinc-500 text-sm max-w-xs">
                            Defining the new standard for modern fashion retail.
                            Clean lines, bold choices.
                        </p>
                        <div className="flex gap-2">
                            <Button size="icon" variant="outline" className="rounded-full w-10 h-10 border-zinc-200 text-zinc-900">
