    ...
    <main className="min-h-screen bg-zinc-50 pb-20">
      ...
      <section className="mx-auto max-w-[1400px] px-4 py-24">
        <div className="flex justify-between items-baseline mb-12">
          <h2 className="text-2xl font-bold uppercase tracking-tight text-zinc-900" data-animate="text">Shop by Category</h2>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-6 lg:gap-x-8 gap-y-12" data-animate="grid">
          {[
      ...
      <section className="mx-auto max-w-[1400px] px-4 pb-24">
        <div className="flex justify-between items-end mb-12">
          <h2 className="text-2xl font-bold uppercase tracking-tight text-zinc-900" data-animate="text">Trending Now</h2>
          <Button asChild href="/collections/all" variant="link" className="text-zinc-500 hover:text-zinc-900 font-medium tracking-wide uppercase text-xs p-0 h-auto" data-animate="button">
            View All
          </Button>
        </div>

        <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-6 lg:gap-x-8 gap-y-12" data-animate="grid">
      ...
      <section className="mx-auto max-w-[1400px] px-4 py-32">
        <Link href="/collections/weekend-edit" className="block relative w-full h-[600px] md:h-[800px] rounded-2xl overflow-hidden group" data-animate="parallax">
          <Image
